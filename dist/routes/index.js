...
const attractions_routes_1 = __importDefault(require("./attractions.routes"));
...
const destinations_routes_1 = __importDefault(require("./destinations.routes"));
...
router.use('/attractions', attractions_routes_1.default);
router.use('/bookings', bookings_routes_1.default);
router.use('/categories', categories_routes_1.default);
router.use('/destinations', destinations_routes_1.default);
router.use('/tenants', tenants_routes_1.default);
router.use('/users', users_routes_1.default);
router.use('/payments', payments_routes_1.default);
// Admin routes aliases
router.use('/admin/attractions', attractions_routes_1.default);
router.use('/admin/bookings', bookings_routes_1.default);
router.use('/admin/categories', categories_routes_1.default);
router.use('/admin/destinations', destinations_routes_1.default);
router.use('/admin/tenants', tenants_routes_1.default);
