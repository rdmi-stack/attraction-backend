...
const tenantSchema = new Schema<ITenant>(
  {
    ...
    designMode: {
      type: String,
      enum: ['default', 'luxury', 'minimal', 'nautical', 'equestrian', 'marine', 'desert', 'safari', 'travel', 'stable', 'sunmarine', 'rittal', 'speedboat', 'ancient', 'pyramid', 'skyride', 'temple', 'ranch', 'reef', 'obelisk', 'dune', 'savanna', 'expedition', 'dolphin', 'safarisahara', 'quadtour', 'desertfox', 'pharaonic', 'luxorballoon', 'nilenight'],
      default: 'default',
    },
    defaultCurrency: {
      type: String,
